...
CPPPATH_NODE = '/Users/steve.krenek/.nvm/v0.6.15/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-O3', '-arch', 'x86_64']
CXXFLAGS_DEBUG = ['-g']
...
LIBDIR = '/Users/steve.krenek/.node_libraries'
LIBPATH_NODE = '/Users/steve.krenek/.nvm/v0.6.15/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS = ['-O3', '-arch', 'x86_64']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/steve.krenek/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/steve.krenek/.nvm/v0.6.15'
