...
var testEntries = {"total_rows":3,"offset":0,"rows":[
    {"id":"T07c6a417c9d30cbe8daff66d26f9adff","key":[2011,2,3,22,30,0],"value":{"pubDate":{},"summary":"Test: The JoJo Blog is Born","post":"Today the JoJo Blog was born.  Long may it live."}},
    {"id":"T3903aaa23008e1359b13911fc3d4d208","key":[2011,2,4,13,0,0],"value":{"pubDate":{},"summary":"Test: Getting Widgetized","post":"This morning I worked on turning the JoJo Blog into a fully widget-ized jojojs app."}},
...
var api = new blogapi();
var viewStub = new sinon.stub(jojo.data.appdb.getRawDb(), "view", function() {
