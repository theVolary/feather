  ...
  feather.dom = new (require("./dom").DomResource)({
    onceState: {
      ready: function() {
         ...
         */
        feather.widget.instanceScriptTemplate = feather.dom.$j.template(null, [
        ...
        require("./widget.server").init({feather: feather});
        ...
        feather.stateMachine.onceState("loadingComplete", function() {
          ...
          serverDotSocket.init(_.extend({feather:feather}, options));
