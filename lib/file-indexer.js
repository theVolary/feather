        ...
        if (path.indexOf('feather-res-cache') < 0) {           
          ...
          files.forEach(function(file) {
            ...
            if (file.match(/\.feather\.html$/)) {
              ...
              fObj.data = adjustTemplateData(templateData);
            }
...
var adjustTemplateData = exports.adjustTemplateData = function(templateData) {
  ...
  return templateData.replace(idFixRegex, idFixReplacement);
}