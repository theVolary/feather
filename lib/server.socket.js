...
var reservedErrorMessage = "Disallowed or reserved message type attempt. Reserved messages: " + reservedStr;
...
feather.socket.channel = Class.create(feather.lang.registry, {
  ...
  error: function(client, errorType, errorMessage, errorData) {
    if (!client || !errorType || !errorMessage) return;
    var me = this;
    client.send({
      type: "channel",
      channelId: this.id,
