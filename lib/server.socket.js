 ...
 */
var reservedMessages = ["subscribe", "connection", "disconnection", "error"];
...
feather.socket.channel = Class.create(feather.lang.registry, {
  initialize: function($super, options) {
    ...
    options.announceConnections = typeof options.announceConnections === "undefined" ? true : options.announceConnections;
    $super(options);
  },
  add: function($super, client, message) {
    var me = this;
  ...
  error: function(client, err, logMessage) {
