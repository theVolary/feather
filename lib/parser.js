          ...
          domPool.getResource(function(dom) {      
            ...
            Widget.render({
              ...
              if (err) cb(err); else {
                 ...
                 */
                logger.info({message:"Parser packaging framework resources.", category:"feather.parser", immediately:true});
                var rpSem = new Semaphore(function() {
                  logger.debug({message:"Parser rendering output for " + path, category:"feather.parser", immediately:true});
                  ...
                  logger.debug({message: "Parser calling callback after render created.", category:"feather.parser", immediately:true});
                  cb(null, render);
                });
