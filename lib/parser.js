            ...
            Widget.render({
              ...
              if (err) cb(err); else {
                ...
                ResourcePackager.packageFrameworkResources({
                  ...
                  restProxyInfo: options.restProxyInfo
                }, function() {
                  ResourcePackager.packageWidgetResources({
                    ...
                    // Call resource packager to publish _html.
    ...
    if (err) cb(err); else {
      ...
      domPool.getResource(function(dom) {
        ...
        if (options.options.content) {
          var contentTemplate = $j("<contentTemplate></contentTemplate>")
            .appendTo(widgetEl)
            .html(options.options.content);
        }
