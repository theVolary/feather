...
exports.parse = function(path, options) {
    ...
    fsm.onceState("ready", function() {
        ...
        fs.readFile(path, "utf-8", function(err, data) {
            ...
            sys.puts("parse3: " + html);
            
            document.innerHTML = html;
            
            sys.puts("parse4: " + document.innerHTML);
            ...
            if (scriptStr !== "") {
              //TODO: convert to $j
              $j("<script type='text/javascript'>" + scriptStr + "</script>").appendTo(body);
            }
