...
exports.init = function(appOptions) {
  ...
  */
  ...
  jojo.data.dataInterface = Class.create(jojo.event.eventPublisher, {
    initialize: function($super, options) {
      ...
      jojo.logger.info({message:"Initializing data provider " + providerName, category:"jojo.data"});
      ...
      jojo.logger.info({message:"Provider " + provider.name + " is ready.", category:"jojo.data"});
    }, // end initialize
  ...
  if (jojo.appOptions.data) {
    if (jojo.appOptions.data.appdb) {
      jojo.data.appdb = new jojo.data.dataInterface(jojo.appOptions.data.appdb);
    }
    if (jojo.appOptions.data.authdb) {
      jojo.data.authdb = new jojo.data.dataInterface(jojo.appOptions.data.authdb);
    }
  }
};