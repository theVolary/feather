...
EventPublisher.prototype.emit = EventPublisher.prototype.fire = function (type) {
  ...
  //TODO: review performance and REFACTOR; find fastest way to send 'sender' along with data
  ...
  /*var args = toArray(arguments); //1 new object (yuck)
  var arg1 = args.length == 2 ? 
    (args[1] !== undefined ? args[1] : {sender: this}) : //another new object (yuck yuck)
    {sender: this};
