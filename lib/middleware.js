        ...
        if (err) cb(err); else {      
          ...
          var middleware = [
            ...
            function(req, res, next) {
              ...
              // If ignorePaths contains this request's path, skip the connect bodyParser.
              if (options.connect.bodyParser.ignorePaths[nodeUrl.parse(req.url).pathname]) {
                next();
              } else {
            ...
            function(req, res, next) {
              ...
              if (files.featherFiles[_path]) {
                ...
                for (var pageRoute in options.pageRoutes) {
                  if (req.url.match(new RegExp(pageRoute))) {
                    req.isFeatherPage = true;
