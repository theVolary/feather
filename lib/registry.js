...
/**
 * @class A registry is an iterable collection of objects keyed by an ID.  It is functionally 
 * equivalent to what a Map would be in Java, or a Dictionary in .NET, with the exception 
 * that the ID is expected to be a property on the object, and all objects stored in the registry 
 * must have that property.
 * @param {Object} options
 * @param {Object} defaults
 * @extends EventPublisher
 */
function Registry(options, defaults) {
  Registry.super.call(this, options, _.extend({
    idKey: "id",
    uniqueErrorMessage: "Error: All items in this registry instance must have unique IDs."
  }, defaults || {}));
  ...
  add: function(item, index) { 
    ...
    if (item[idKey]) {
      if (typeof this.itemCache[item[idKey]] !== "undefined") {
        throw new Error(options.uniqueErrorMessage + "\n\nid: " + item[idKey]);
      }
...
inherits(Registry, EventPublisher);
