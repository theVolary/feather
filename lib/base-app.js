...
var defaultOptions = {
  ...
  enableLogging: true,
  runAsDaemon: false,
  daemonOutputPath: path.basename(__dirname)+'.log',
...
jojo.start = function(options) {
  ...
  if (mergedOptions.runAsDaemon) {
    var daemon = require("daemon");
    daemon.daemonize(mergedOptions.daemonOutputPath, mergedOptions.daemonPidPath, function(err, pid) {
