...
exports.init = function(appOptions) {
        ...
        rendering: {
            stateStartup: function(widget, args) {
                ...
                jojo.widget.renderMachine.onceState("rendering", function() {
                    ...
                    if (!widget.container && widget.containerId) {
                        widget.container = $j("#" + widget.containerId);
                    }
                    if (widget.template && widget.container) {
                        ...
                        var tmpl = $j.tmpl(widget.template, widget);
    ...
    jojo.widget.renderMachine = new jojo.fsm.finiteStateMachine({
        states: {
            ...
            ready: {
                assembling: function(fsm, args) {
                    return fsm.states.assembling;
                },
                render: function(fsm, args) {
                    return fsm.states.rendering;
                }
            },
            assembling: {
                render: function(fsm, args) {
