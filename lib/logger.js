...
Level.prototype.toString = function() { return this.levelName; };
...
Level.prototype.isOff = function() {
  ...
  states: {
    initial: {
      stateStartup: function(fsm, args) {
        fsm.templates = new registry({unique:true});
