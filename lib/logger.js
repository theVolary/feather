...
function MyLogger(options) {
  ...
  MyLogger.super.apply(this, arguments);
};
...
inherits(MyLogger, EventPublisher);
...
['trace', 'debug', 'info', 'warn', 'error', 'fatal'].forEach(function(levelString) {
  ...
  MyLogger.prototype[levelString] = function (message, exception) {
