...
module.exports = /** @lends Util.prototype */ {
   ...
   *
   * NOTE: This is a naive implementation, in that we're not extending getters and setters properly.
   * Only use this for simple data model type objects.
   *
   * @param {Object} The object to augment
   * @param {Object} The object to augment from
   */
