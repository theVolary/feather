...
//inherits(fsm, eventPub);
inherits(fsm, baseClass);
...
function fsm(options) {
  ...
  options.states.global.error = options.states.global.error || this.gotoErrorState;
 ...
 * @param {Object} args
 */
fsm.prototype.fsmEvent = function(eventName, args) {            
 ...
 */
fsm.prototype.gotoState = function(state, eventName, eventArgs) {
 ...
 */
fsm.prototype.onState = function(state, callback, once) {
  var me = this;
 ...
 * @param {Function} callback
 */
fsm.prototype.onceState = function(state, callback) {
 ...
 */
fsm.prototype.getCurrentStateName = function() {
