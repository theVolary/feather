...
var utils = require('../node_modules/connect/lib/utils')
...
function router(fn){
  ...
  function generateMethodFunction(name) {
    ...
    var ret = function(path, fn){
      ...
      //console.trace("Added route " + path + " for verb " + name);
      return self;
    }; 
    return ret;
  }
...
function match(req, routes, i) {
  var captures
    , method = req.method
    , i = i || 0;
  if ('HEAD' == method.toUpperCase()) method = 'GET';
