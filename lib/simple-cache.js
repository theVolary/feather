...
exports.getItem = function(key, cb) {
  ...
  if (typeof key !== "string") {
    ...
    cb && cb("No item found with key '" + key + "'");
  }	else {
    var item = cache[key];
...
exports.setItemReadOnly = function(key, value, token, cb) {
  if (typeof cb !== "undefined" && typeof cb !== "function") {
...
exports.deleteItem = function(key, cb) {
  if (typeof cb !== "undefined" && typeof cb !== "function") {
    throw new Error("The 2nd argument (if supplied) is expected to be a callback function");
  }
  if (typeof key !== "string") {
...
exports.deleteItemReadOnly = function(key, token, cb) {
  if (typeof cb !== "undefined" && typeof cb !== "function") {
    throw new Error("The 3rd argument (if supplied) is expected to be a callback function");
  }
  if (typeof key !== "string") {
