//TODO: remove the Prototypejs holdovers. Even though we now have a shim to the underscore module,
//we should probably do away with Class.create in favor of a pure ES5 approach. AFAIK this is the 
//only thing keeping the Prototypejs holdover functions bound to the project.
//
//target replacement for Class.create is the inherits module in npm ('npm install inherits')
...
exports.init = function(appOptions) {
    ...
    /**
     * Plucks the given property from each item in the array and pushes it onto a new array, which is returned upon completion.
     * @augments Array
      ...
      addMethods: function(source) {
        ...
        for (var i = 0, length = properties.length; i < length; i++) {
          ...
          if (ancestor && (typeof value == "function") &&
            ...
            /*
            // method is the child function that's overriding the parent.  
            // The parent's function becomes the $super variable passed into the child functions as the first arg.
            var method = value;
            var funcToWrap = (function(m) { return function() { ancestor[m].apply(this, arguments); }; })(property);
            var wrappedFunc = _.wrap(funcToWrap, method);
            var value = Object.extend(func, {
