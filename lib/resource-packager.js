...
exports.packageResources = function(options) {
  ...
  if (!cache) {
    newCache = true;
    feather.logger.debug("Building cache " + options.cacheName);
...
exports.packageFrameworkResources = function(options) {
  ...
  var fileArray = [
    ...
    {path: "feather-client/lib/jquery-1.4.2.js", prefix: prefix},
  ...
  if (feather.appOptions.auth.enabled) {
    fileArray.push({path: "feather-client/sha512.js", prefix: prefix});
    fileArray.push({path: "feather-client/auth-client.js", prefix: prefix});
  }
