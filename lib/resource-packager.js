 ...
 *    ]
 * }</pre>
 * @name resource-packager.packageResources
 ...
 * @name resource-packager.packageFrameworkResources
 ...
 * @name resource-packager.packageWidgetResources
 * @param {Object} options
 */
...
function packageWidgetJs(options) {
  ...
  var packageInfo = {
    template: '<clientscript type="text/javascript" src="${href}"></clientscript>',
    cacheName: "featherjs/" + feather.request.page + ".js",
    hrefPrefix: "",
    batchHrefPrefix: "/",
    contentType: "text/javascript",
    debug: options.debug,
...
function packageWidgetCss(options) {
  ...
  var packageInfo = {
    ...
    cacheName: "feathercss/" + feather.request.page + ".css",
    hrefPrefix: "",
    batchHrefPrefix: "/",
