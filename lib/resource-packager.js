    ...
    options.files.each(function(file){
      ...
      if (newCache) {
        try {
          ...
          if (consolidate && options.contentType === "text/css") {
            content = resolveCssUrls(filePath, content);
          }
...
exports.resolveCssUrls = function (filePath, content) {
  ...
  return content.replace(urlRegex, function(match, prefix, cssUrl /*, offset, str */) {
