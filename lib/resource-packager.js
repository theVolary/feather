...
exports.packageFrameworkResources = function(options, callback) {
  simpleCache.getItem('feather-files', function(err, featherFiles) {
    ...
    if (options.appOptions["socket.io"].enabled) {
      ...
      var portAppend = (options.appOptions["socket.io"].port == "80" || options.appOptions["socket.io"].port == "443") ? "" : ":" + options.appOptions["socket.io"].port;
      var socketPrefix = socketProtocol + "://" + options.appOptions["socket.io"].host + portAppend;
    }
