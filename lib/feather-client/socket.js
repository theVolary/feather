//this line helps the likes of FF and IE find the faster-than-XHR flash socket transport
WEB_SOCKET_SWF_LOCATION = '/socket.io.client/lib/vendor/web-socket-js/WebSocketMain.swf';
...
(function() {
  ...
  feather.stateMachine.onceState("ready", function() {
    ...
    feather.socket.client = new io.Socket(null, {
      ...
      secure: feather.appOptions.isSecure,
  ...
  var eventBus = feather.socket.eventBus = function() {
    eventBus.super.apply(this, arguments);
  };
  eventBus.prototype = {
    fire: function(eventName, eventArgs, callback) {
      if (eventName.indexOf("broadcast:") > -1) {
        return eventBus.super.prototype.fire.call(this, eventName, eventArgs);
      }
    ...
    on: function(eventName, handler) {
      return eventBus.super.prototype.on.call(this, "broadcast:" + eventName, handler);
    }
  };
  ...
  var channelClass = function(){
    channelClass.super.apply(this, arguments);
  };
  channelClass.prototype = {
    ...
    dispose: function() {
      ...
      channelClass.super.prototype.dispose.apply(this, arguments);
    }
  };
