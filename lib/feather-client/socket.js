...
(function() {
  ...
  feather.stateMachine.onceState("ready", function() {
    ...
    if (feather.appOptions["socket.io"].enabled) {
      var portAppend = (feather.appOptions["socket.io"].port == "80" || feather.appOptions["socket.io"].port == "443") ? "" : ":" + feather.appOptions["socket.io"].port;
      var url = protocol + "://" + feather.appOptions["socket.io"].host + portAppend;
