(function() {
   ...
   */
  var dlgTmpl = "<div id='${id}' title='${title}'><content/></div>";
  feather.ui.Dialog = feather.Widget.create({
    name: "feather.ui.Dialog",
    path: "feather-client/ui/Dialog/",
    clientOnly: true,
    template: "<div id='container' title='${options.title}'><content/></div>",
    prototype: {
      ctor: function(options) {
        ...
        this.contentTemplate = $("<contentTemplate>" + options.content + "</contentTemplate>");
