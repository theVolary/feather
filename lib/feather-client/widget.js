(function() {
  ...
  var optionTagFixRegex = /<(\/*)option\s/g;
  var contentTagFixRegex = /<(\/*)content\s/g;
  var contentTemplateTagFixRegex = /<(\/*)contentTemplate/g;
  var optionsSelector = $.browser.msie ? "options" : "feather\\:options";
  var optionSelector = $.browser.msie ? "option" : "feather\\:option";
  ...
  var Widget = feather.Widget = function(options) {
    ...
    if (typeof this.contentTemplate === "string") {
      this.contentTemplate = this.contentTemplate
        ...
        .replace(optionTagFixRegex, "<$1feather:option ")
