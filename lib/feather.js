...
var feather = module.exports = /** @lends feather */ {
  ...
  init: function(options) {
    ...
    feather.logger.info({message: "Using environment ${environment}.", replacements: options, category: 'feather.srvr', immediately: true});
  ...
  /**
   * expose our version of Connect, with the router attached, so that he app can use it in it's custom middleware if needed
   */
  Connect: (function() {
